...
import { RoflAppDetailView } from '../RoflAppDetailPage'
          ...
          <VerticalList>
            {!isLoading &&
              [...Array(limit).keys()].map(key => (
                <RoflAppDetailView key={key} isLoading={true} app={undefined} />
              ))}
            {isLoading && mockedApps.map(app => <RoflAppDetailView key={app.id} app={app} />)}
          </VerticalList>
        )}
      </SubPageCard>
    </PageLayout>
