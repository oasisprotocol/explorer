...
import { SapphireGraphTooltip } from '../../GraphTooltip/SapphireGraphTooltip'
import { EmeraldGraphTooltip } from '../../GraphTooltip/EmeraldGraphTooltip'
import { CipherGraphTooltip } from '../../GraphTooltip/CipherGraphTooltip'
import { ConsensusGraphTooltip } from '../../GraphTooltip/ConsensusGraphTooltip'
...
const GraphCmp: ForwardRefRenderFunction<SVGSVGElement, GraphProps> = (
  ...
  const disabledMap = useConstant<{
    [key in GraphEndpoint]: boolean
  }>(() => ({
    [GraphEndpoints.Emerald]: isGraphEndpointDisabled(GraphEndpoints.Emerald),
    [GraphEndpoints.Consensus]: isGraphEndpointDisabled(GraphEndpoints.Consensus),
    [GraphEndpoints.Cipher]: isGraphEndpointDisabled(GraphEndpoints.Cipher),
    [GraphEndpoints.Sapphire]: isGraphEndpointDisabled(GraphEndpoints.Sapphire),
  }))
  ...
  const onSelectGraphEndpoint = (graphEndpoint: GraphEndpoint) => {
    ...
    if (
      ...
      navigate(RouteUtils.getDashboardRoute(selectedGraphEndpoint as ParaTime))
  ...
  return (
    ...
    >
      ...
      <ellipse
        ...
        aria-disabled={disabledMap[GraphEndpoints.Consensus]}
        cx="189.733"
        cy="171.311"
        rx="52.9926"
        ry="52.9926"
      ...
      <ConsensusGraphTooltip offsetWidth={consensusRect?.width} offsetHeight={consensusRect?.height}>
        <circle
          ref={consensusRef}
      ...
      >
        <g
          ...
          aria-disabled={disabledMap[GraphEndpoints.Emerald]}
      ...
      <path
        ...
        fill="white"
      />
      <CipherGraphTooltip offsetWidth={cipherRect?.width} offsetHeight={cipherRect?.height}>
        <g
          ref={cipherRef}
          aria-disabled={disabledMap[GraphEndpoints.Cipher]}
          filter="url(#filter1)"
      ...
      <path
        ...
        aria-disabled={disabledMap[GraphEndpoints.Sapphire]}
        onClick={() => onSelectGraphEndpoint(GraphEndpoints.Cipher)}
