...
const GraphCmp: ForwardRefRenderFunction<SVGSVGElement, GraphProps> = (
  ...
  const { consensusDisabled, cipherDisabled, sapphireDisabled } = useConstant(() => ({
    consensusDisabled: isGraphEndpointDisabled(GraphEndpoints.Consensus),
  ...
  return (
    ...
    >
      ...
      <ellipse
        ...
        aria-disabled={isGraphEndpointDisabled(GraphEndpoints.Consensus)}
        cx="189.733"
        cy="171.311"
        rx="52.9926"
        ry="52.9926"
      ...
      >
        <circle
          ...
          aria-disabled={consensusDisabled}
          onClick={() => onSelectGraphEndpoint(GraphEndpoints.Consensus)}
          cx="189.733"
          cy="171.311"
          r="37.3907"
      ...
      <ConsensusTooltip offsetWidth={consensusRect?.width} offsetHeight={consensusRect?.height}>
        <circle
          ref={consensusRef}
      ...
      <path
        ...
        fill="white"
      />
      <CipherTooltip offsetWidth={cipherRect?.width} offsetHeight={cipherRect?.height}>
        <g
          ref={cipherRef}
          aria-disabled={cipherDisabled}
          filter="url(#filter1)"
